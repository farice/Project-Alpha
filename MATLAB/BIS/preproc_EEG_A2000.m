...
%% optional figures for visualization
...
%xlabel('Time (Min)'); ylabel('Frequency (Hz)'); title('EEG Ch2');
    ...
    message = sprintf('subj %d dne', i)
    disp(message)
end
end


% machine-contingent project paths -- change as needed !
% ensure fieldtrip and eeglab are installed before use, then provide paths below
